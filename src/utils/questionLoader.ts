...
const countQuestionsInSection = async (section: string): Promise<number> => {
  ...
  const sectionLimits: { [key: string]: number } = {
    brush: 200,     // Только Q1 существует
    forearm: 200,   // Q1, Q2, Q3 существуют
    hip: 200,       // Только Q1 существует
    humerus: 200,   // Только Q1 существует
    pelvis: 200,    // Q1, Q2, Q3 существуют
    ribs: 200,      // Q1, Q2, Q3 существуют
    shin: 200,      // Q1, Q2, Q3 существуют
    spine: 200,     // Q1, Q2, Q3 существуют
    foot: 200       // Q1, Q2, Q3 существуют
  };
